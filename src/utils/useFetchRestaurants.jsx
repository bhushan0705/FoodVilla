...
const useFetchRestaurants = () => {
  ...
  async function fetchRestaurants() {
    try {
      ...
      alert("`https://cors-anywhere.herokuapp.com/https://www.swiggy.com/dapi/restaurants/list/v5?lat=28.7040592&lng=77.10249019999999&collection=` go here and give access to block corps issue")
    } finally {
      // for loading the
      setLoading(false);
    }
