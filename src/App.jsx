...
// this is lazy loading (this is not a normal import it is a function here)
let InstaMart = lazy(()=>import('./components/InstMart'))
...
// useSelector is bridge between the store to component (it will get data from slices/ store)
  ...
  // let [logInUser, setLogInUser] = useState(true);
  ...
  <ul className="flex gap-20 text-lg text-white dark:text-gray-100">
    <li>
      <Link to="/" className="hover:text-green-500 dark:hover:text-green-300">
        Home
      </Link>
    </li>
    <li>
      <Link to="/about" className="hover:text-green-500 dark:hover:text-green-300">
        About
      </Link>
    </li>
    <li>
      <Link to="/contact" className="hover:text-green-500 dark:hover:text-green-300">
        Contact
      </Link>
    </li>
    <li>
      <Link to="/instamart" className="hover:text-green-500 dark:hover:text-green-300">
        InstaMart
      </Link>
    </li>
    ...
    {isAuthenticated && (
      <li className="relative cursor-pointer">
        <Link to="/cart" className="hover:text-green-500 dark:hover:text-green-300">
          🛒
